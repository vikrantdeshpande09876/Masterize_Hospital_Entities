...
_STD_COLS_ORDER = ['POSTAL_CODE', 'SITE_NAME', 'STATE', 'CITY', 'ADDRESS_LINE_1', 'ADDRESS_LINE_2', 'ADDRESS_LINE_3', 'COUNTY_NAME', 'PHONE_NUM', 'SITE_TYPE', 'SITE_OWNERSHIP', 'ACCOUNT_NUM']
